...
export default class OmnichannelthemeElementLightningTreeGrid extends LightningElement {
    ...
    connectedCallback() {
        console.log('inside Oc_an_productSelectionTreeGrid');
        debugger;
        //Load style sheets
        Promise.all([
        ...
        console.log('gridColumn>>>>' +this.gridColumn);
    }

    //To load gird data to component's tracked attribute tableData
    initData(){
        
        console.log('this is in trgree init griddata' +JSON.stringify(this.gridData));
        ...
        console.log('tree init tabledata' +this.tableData);
    ...
    handleRowSelection(event){
        ...
        //console.log(this.template.querySelector('c-oc_an_product-selection-tree-grid').getSelectedRows());
        
        this.changeTreeSelctions(this.tableData, this.calculateTreeSelections(event.detail));
        //console.log('handlerow' +JSON.stringify(this.tableData) +'  second paramter: ' +JSON.stringify(event.detail) );
        //console.log('handle second paramter: ' +JSON.stringify(event.detail) );
    }
    ...
    handleScroll(event){
        ...
        if( Math.ceil(event.currentTarget.scrollTop) + event.currentTarget.offsetHeight >= event.currentTarget.scrollHeight ){
    ...
    changeTreeSelctions(tableData, currentSelectionEffectMap){
       // console.log('selected rows change tree:' +JSON.stringify(tableData));
    ...
    //
    @api getSelectedRows(){
       // console.log('this is selected rows...');
        var selectedRows = {};
        var deselectedRows = {};
